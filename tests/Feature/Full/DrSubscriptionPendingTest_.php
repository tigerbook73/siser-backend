...
class DrSubscriptionPendingTest_ extends DrApiTestCase
{
  ...
  public function test_pending_to_failed_error_fulfill()
  {
    ...
    $response = $this->sendOrderAccepted(
      $this->drHelper->getDrOrder(
        $subscription->getNewSubscriptionInvoice()->getDrOrderId()
      )->setState(DrOrder::STATE_ACCEPTED)
    );
